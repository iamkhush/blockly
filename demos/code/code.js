 ...
 * @private
 */
Code.TABS_ = ['blocks', 'javascript', 'php', 'python', 'dart', 'lua', 'xml', 'cplus'];
...
Code.renderContent = function() {
  ...
  } else if (content.id == 'content_cplus') {
    code = Blockly.Cplus.workspaceToCode(Code.workspace);
    content.textContent = code;
    if (typeof prettyPrintOne == 'function') {
      code = content.innerHTML;
      code = prettyPrintOne(code, 'cplus');
      content.innerHTML = code;
    }
  }
};
